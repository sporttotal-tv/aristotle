...
const parseImportDeclaration = (node, imports, path, store) => {
...
const parseImports = ({ exportStats, id, imports, store }) => {
  return {
    ...
    ImportDeclaration(path) {
      parseImportDeclaration(path.node, imports, path, store)
    }
  }
}
