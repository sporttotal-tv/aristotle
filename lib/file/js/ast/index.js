...
// console.log(!!objectRest, !!env, !!traverse, !!reactPreset, !!classProps)
...
exports.parseCode = (file, raw, dontParseRequires, type) => {
  ...
  try {
    ...
    var { ast, code: codeInput } = babel.transformFromAst(ast2, raw, {
      ast: true,
      plugins,
      presets: [reactPreset]
    })
    ...
    var { code } = babel.transformFromAst(ast, codeInput, {
      plugins: [
        deadCode2,
        useStrict,
        props => {
